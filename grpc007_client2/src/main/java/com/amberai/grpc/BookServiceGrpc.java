...
public final class BookServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.amberai.grpc.GrpcLib.addBookRequest,
      com.amberai.grpc.GrpcLib.GrpcReply> getAddBookMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "addBook",
      requestType = com.amberai.grpc.GrpcLib.addBookRequest.class,
      responseType = com.amberai.grpc.GrpcLib.GrpcReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.amberai.grpc.GrpcLib.addBookRequest,
      com.amberai.grpc.GrpcLib.GrpcReply> getAddBookMethod() {
    io.grpc.MethodDescriptor<com.amberai.grpc.GrpcLib.addBookRequest, com.amberai.grpc.GrpcLib.GrpcReply> getAddBookMethod;
      ...
      synchronized (BookServiceGrpc.class) {
        if ((getAddBookMethod = BookServiceGrpc.getAddBookMethod) == null) {
          BookServiceGrpc.getAddBookMethod = getAddBookMethod = 
              io.grpc.MethodDescriptor.<com.amberai.grpc.GrpcLib.addBookRequest, com.amberai.grpc.GrpcLib.GrpcReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "grpc.BookService", "addBook"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.amberai.grpc.GrpcLib.addBookRequest.getDefaultInstance()))
  ...
  public static abstract class BookServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void addBook(com.amberai.grpc.GrpcLib.addBookRequest request,
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.amberai.grpc.GrpcLib.addBookRequest,
  ...
  public static final class BookServiceBlockingStub extends io.grpc.stub.AbstractStub<BookServiceBlockingStub> {
    ...
    /**
     */
    public com.amberai.grpc.GrpcLib.GrpcReply addBook(com.amberai.grpc.GrpcLib.addBookRequest request) {
  ...
  public static final class BookServiceFutureStub extends io.grpc.stub.AbstractStub<BookServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.amberai.grpc.GrpcLib.GrpcReply> addBook(
        com.amberai.grpc.GrpcLib.addBookRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ADD_BOOK:
          serviceImpl.addBook((com.amberai.grpc.GrpcLib.addBookRequest) request,
              (io.grpc.stub.StreamObserver<com.amberai.grpc.GrpcLib.GrpcReply>) responseObserver);
          break;
        default:
